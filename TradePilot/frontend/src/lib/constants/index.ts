...
export const ROUTES = {
  ...
  SECTORS: '/sectors',
  SECTOR_DETAIL: (code: string) => `/sectors/${code}`,
  SECTOR_FLOW: '/sectors/flow',
  SIGNALS: '/signals',
  SIGNAL_DETAIL: (id: string) => `/signals/${id}`,
  SIGNAL_RULES: '/signals/rules',
  AUTO_TRADING: '/auto-trading',
  AUTO_TRADING_NEW: '/auto-trading/new',
  AUTO_TRADING_DETAIL: (id: string) => `/auto-trading/${id}`,
  AUTO_TRADING_EDIT: (id: string) => `/auto-trading/${id}/edit`,
  AUTO_TRADING_LIMITS: '/auto-trading/limits',
  AUTO_TRADING_ORDERS: '/auto-trading/orders',
  REPORT: '/report',
  REPORT_TRADES: '/report/trades',
  REPORT_STRATEGIES: '/report/strategies',
  BACKTEST: '/backtest',
  BACKTEST_DETAIL: (jobId: string) => `/backtest/${jobId}`,
  BACKTEST_HISTORY: '/backtest/history',
  SETTINGS: '/settings',
  SETTINGS_CREON: '/settings/creon',
